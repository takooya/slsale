...
<footer>
    <p class="pull-left">&copy; <a href="http://usman.it" target="_blank">Takooya</a> 2012</p>
    <p class="pull-right">Powered by: <a href="http://usman.it/free-responsive-admin-template">Takooya</a></p>
</footer>
